...
# Использование: .\deploy-smtp-fix.ps1

$SERVER = "root@VM-396498"
$PROJECT_DIR = "/var/www/woxly"
$BACKEND_DIR = "$PROJECT_DIR/apps/backend"

Write-Host "🚀 Deploying SMTP fix to production..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    Write-Host ""
    Write-Host "✅ SMTP fix deployed successfully!" -ForegroundColor Green
    Write-Host "📝 Check logs with: ssh $SERVER 'pm2 logs woxly-backend'" -ForegroundColor Cyan
} else {
    Write-Host ""
